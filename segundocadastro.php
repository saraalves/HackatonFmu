...
<p id="segundo">2º integrante</p>

<div class="container">
	
	<!--<img src="fmulogo.jpg">-->

	<form id="container2" method="post" action="terceirocadastro.php">
		
		<center><input type="text" placeholder="Nome" name="nomed"></center>
		
		<center><input type="text" placeholder="RA" name="rad"></center>
