...
<head>
	<title>Paises</title>
	<meta charset="utf-8">
	<script type="text/javascript" src="javascripttres.js"></script>
	<style type="text/css">
		body {
	margin: 0;
	padding: 0;
...
<div id="fundopais2">
	...
	<form name="form" method="post" action="Brasil/PERGUNTA17/pergunta17brasil.html" onsubmit="return validacao();">
...
<a href="Mapa/mapaBrasil.html"><img id="local" src="local.png"></a>
