...
<head>
	<title>Paises</title>
	<meta charset="utf-8">
	<script type="text/javascript" src="javascriptcinco.js"></script>
	<style type="text/css">
		body {
	margin: 0;
	padding: 0;
...
<div id="fundopais2">
	...
	<form name="form" method="post" action="alemanha\POSTO01EUAPERGUNTA1.php" onsubmit="return validacao();">
...
<a href="mapa/mapaAlemanha.html"><img id="local" src="local.png"></a>
