...
<head>
	<title>Paises</title>
	<meta charset="utf-8">
	<script type="text/javascript" src="javascriptseis.js"></script>
	<style type="text/css">
		body {
	margin: 0;
	padding: 0;
...
<div id="fundopais2">
	...
	<form name="form" method="post" action="suica\05suica.html" onsubmit="return validacao();">
...
<a href="mapa/mapaSuica.html"><img id="local" src="local.png"></a>
