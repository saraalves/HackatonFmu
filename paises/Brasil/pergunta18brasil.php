...
<p id="pergunta1">18. Para ilustrar este processo, analise a seguinte sequência de figuras e determine o próximo elemento:</p>

<img id="imagem1" src="imagemlogica18.png"/>
</div></center>

	<div id="fundoform">
	<form method="get" action="pergunta19brasil.php">
		<input type="radio" name="opcoes" id="alternativaA" value="A">
		<label for="alternativaA">A) ) Figura A </label><br/>

		<input type="radio" name="opcoes" id="alternativaB" value="B">
		<label for="alternativaB">B) Figura B </label><br/>

		<input type="radio" name="opcoes" id="alternativaC" value="C">
		<label for="alternativaC">C) Figura C </label><br/>

		<input type="radio" name="opcoes" id="alternativaD" value="D">
		<label for="alternativaD">D) Figura D</label><br/>

		<input type="radio" name="opcoes" id="alternativaE" value="E">
		<label for="alternativaE">E) Figura E</label><br/>
