...
<head>
	<title>Paises</title>
	<meta charset="utf-8">
	<script type="text/javascript" src="javascriptquatro.js"></script>
	<style type="text/css">
		body {
	margin: 0;
	padding: 0;
...
<div id="fundopais2">
	...
	<form name="form" method="post" action="eua\PERGUNTA1\POSTO01EUAPERGUNTA1.html" onsubmit="return validacao();">
...
<a href="mapa/mapaEUA.html"><img id="local" src="local.png"></a>
